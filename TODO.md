...
- [x] `EPUB-101` 原生可重排阅读界面、章节导航与章节进度恢复
- [x] `EPUB-102` EPUB 文本选择、前后句提取，并复用侧边栏/弹窗解句流程
- [ ] `EPUB-103` 目录面板、字号/行距/页边距阅读设置
- [ ] `EPUB-104` 图片、强调样式、脚注与链接等富文本呈现
- [ ] `EPUB-105` 固定 EPUB 的打开、翻章、选句解句 UI 测试
- [ ] OCR
- [ ] 1.5B 质量回退建议
- [ ] 更多模型 Provider
- [ ] 数据导出与同步
