...
- **2026-09-15 中英双语开源首页与贡献规范（OSS-011）**：重写中文 `README.md` 并新增完整英文
  ...
  断言。
- **2026-09-15 Windows 竖排 PDF 点按选词（WIN-402C）**：针对 PDF 未声明竖排字体、正文单字与
  小字号振假名交错存储造成的拖选错位，改为从文字层坐标识别竖排栏，按从右到左、从上到下重建
  正文，并过滤约半字号的振假名。竖排页提示“点击文字选词”，点击正文后使用日语分词边界高亮
  完整词并发送无注音的上下文；横排 PDF 继续使用标准拖选。新增 3 项版面/分词测试；共享 Node
  19 项、Windows 104 项和生成 PDF 冒烟通过，真实《白い巨塔》第 101 页端到端确认走竖排选词、
  排除 Ruby 并保留页码 locator。未访问外网或上传书籍。
